...
<div class="flex flex-col gap-3">
	...
	<p>Welcome to <b>Dabber Game</b> (“Company”, “we”, “our”, “us”)!</p>
	<p>
	...
	<p>
		...
		but please let us know by emailing at <b>contact@dabbergame.tn</b> so we can try to find a solution.
	...
	<p>
		...
		your claim via email to contact@dabbergame.tn, with the subject line: “Copyright Infringement”
	...
	<p>You can contact our Copyright Agent via email at contact@dabbergame.tn.</p>
	<p>12. <b>Error Reporting and Feedback</b></p>
	<p>
		You may provide us either directly at contact@dabbergame.tn or via third party sites and tools
		...
		right, title or interest in or to the Feedback; (ii) Company may have development ideas similar
		...
		confidentiality with respect to the Feedback. In the event the transfer of the ownership to the
	...
	<p>
		These Terms shall be governed and construed in accordance with the laws of Tunisia, which
